...
ends <- c(combined[1:3], length(combined) - 2:length(combined))
...
die <- function(){
  die_rolls <- 1:6
  rolls <- sample(die_rolls, 6, replace = T)
  rolls
}
...
die <- function(){
  die_rolls <- 1:6
  rolls1 <- sample(die_rolls, 6, replace = T)
  rolls2 <- sample(die_rolls, 6, replace = T)
  rolls_final = rolls1 + rolls2
  rolls_final
}
